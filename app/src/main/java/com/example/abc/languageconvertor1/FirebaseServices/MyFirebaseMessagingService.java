...
import com.example.abc.languageconvertor1.NotificationUtils;
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                Intent resultIntent = new Intent(getApplicationContext(),com.example.abc.languageconvertor1.Notify.class);
